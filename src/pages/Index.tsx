        ...
        <div className="container mx-auto px-4 relative z-10 py-20">
          ...
          >
            ...
            >
              ...
              <Button asChild size="lg" variant="outline" className="rounded-full px-8 border-background/20 text-background hover:bg-background/10">
          ...
          <ScrollReveal>
            <div className="max-w-xl mb-14">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                A full range of pharmacy services to support your health — from delivery to custom compounding.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
            <ScrollReveal direction="left">
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-serif text-foreground mb-10">Transfer in 3 steps</h3>
            ...
            <ScrollReveal direction="right">
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-serif text-foreground mb-10">Refill in 3 steps</h3>
                <div className="space-y-8">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-0.5">
                          {[...Array(reviews[currentReview].rating)].map((_, j) => (
                            <Star key={j} className="h-3 w-3 fill-[#FBBC05] text-[#FBBC05]" />
                          ))}
                        </div>
                      </div>
                      <svg viewBox="0 0 24 24" className="h-5 w-5 flex-shrink-0 opacity-40" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/>
                        <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
                        <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
                        <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
              ...
              {reviews.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    i === currentReview ? 'bg-primary w-8' : 'bg-border w-1.5 hover:bg-muted-foreground/40'
                  }`}
