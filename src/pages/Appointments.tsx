...
export default function Appointments() {
  ...
  const [formData, setFormData] = useState({ name: "", phone: "", contactMethod: "call", preferredDay: "", preferredTime: "", notes: "" });
          ...
          <div className="max-w-2xl mx-auto">
            ...
            {selectedType && (
              <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
                ...
                <Button type="submit" className="w-full rounded-full gap-2" size="lg">Submit Request <ArrowRight className="h-4 w-4" /></Button>
              </form>
            )}
          </div>
        </div>
