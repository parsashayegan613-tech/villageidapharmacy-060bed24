...
const reviews = [
    ...
    { rating: 5, text: "Switching to Village IDA was the best decision for my family's healthcare. They coordinated with our previous pharmacy and transferred all our prescriptions over the same day. The process was smooth and the service was phenomenal.", author: "David C." },
    { rating: 5, text: "I cannot say enough good things about their compounding service. My 4-year-old had a difficult time taking his antibiotic because of the taste, and Heidi compounded it into a grape flavor that he actually looks forward to taking. It was incredibly helpful.", author: "Sarah T." },
