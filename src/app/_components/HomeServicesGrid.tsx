...
const services = [
    ...
    { icon: ClipboardCheck, title: "Medication Reviews", description: "One-on-one review of your medications.", whoItsFor: "Anyone wanting to understand their medications better.", howItWorks: "Request a private session with our pharmacist." },
    ...
    { icon: Syringe, title: "Injection Services", description: "Flu shots, vaccines, and more.", whoItsFor: "Adults seeking immunizations or injections.", howItWorks: "Walk in or request an appointment." },
