...
export default function AdminTransfers() {
    ...
    const filtered = transfers.filter(t => {
        ...
        return t.full_name.toLowerCase().includes(q) || t.phone.includes(q) || t.current_pharmacy.toLowerCase().includes(q);
    });
    ...
    return (
        <div>
            ...
            <div className="relative mb-5">
                ...
                <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search by name, phone, or pharmacy..." className="w-full pl-9 pr-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-blue-500 transition-colors" />
            </div>
            ...
            <div className="bg-zinc-900 rounded-xl border border-zinc-800 overflow-hidden">
                {loading ? (
                    ...
                    <div className="p-12 text-center text-zinc-500">No transfer requests found.</div>
                ) : (
                ...
                <div className="fixed inset-0 z-50 flex justify-end">
                    ...
                    <div className="relative w-full max-w-md bg-zinc-900 border-l border-zinc-800 h-full overflow-y-auto">
                        ...
                        <div className="p-5 space-y-6">
                            ...
                            <div>
                                <p className="text-zinc-500 text-xs uppercase tracking-wider mb-1.5">Transferring From</p>
                                <p className="text-white font-medium">{selected.current_pharmacy}</p>
                                {selected.current_pharmacy_phone && (
                                    <a href={`tel:${selected.current_pharmacy_phone}`} className="text-blue-400 text-sm hover:underline flex items-center gap-1">
                                        <Phone className="h-3 w-3" />{selected.current_pharmacy_phone}
                                    </a>
                                )}
                            </div>
