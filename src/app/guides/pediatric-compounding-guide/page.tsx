...
export const metadata: Metadata = {
    ...
    description: "Learn how pediatric compounding pharmacies create custom, flavored, dye-free medications for children who have difficulty taking standard prescriptions.",
};
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-headings:font-serif prose-headings:font-medium prose-a:text-primary max-w-none space-y-8">
                        ...
                        <div className="bg-secondary p-8 rounded-2xl border border-border/50 my-10">
                            ...
                            <ul className="mb-0 space-y-4">
                                <li>
                                    <strong>Flavoring:</strong> We can significantly mask bitter tastes with child-friendly flavors like grape, bubblegum, cherry, or marshmallow, helping make daily medication easier to manage.
                                </li>
                                <li>
